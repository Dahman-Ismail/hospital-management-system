...
<div class="max-w-xl mx-auto bg-white shadow-md rounded-lg p-6 mt-6">
    ...
    <form action="/appointments/create" method="post" class="space-y-4">
        <div>
        ...
        <div class="space-x-2">
            <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded">Create</button>
