...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="/doctors/create" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-500 transition">
        Add New Doctor
    </a>
</div>
...
<form method="get" action="/doctors/search/name" class="mb-4 flex gap-2">
    ...
    <button type="submit" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-500">Search</button>
</form>
            ...
            <c:forEach var="doctor" items="${doctors}">
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                        <a href="/doctors/edit/${doctor.id}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                        <a href="/doctors/delete/${doctor.id}" class="text-red-600 hover:text-red-900"
